...
class Cart extends React.Component{
	...
	onDelete(_id){
		// create a copy of the current array of cart items
		...
		// use slice to remove the cart item at the specified index (returning everything before and after the deleted item)
